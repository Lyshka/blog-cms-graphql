	...
	<div className="bg-white shadow-lg rounded-t-3xl p-0 pb-12 mb-8">
		...
		<div className="text-center">
			<Link href={`/post/${post.slug}`}>
				<span className="transition duration-500 ease transform hover:-translate-y-2 inline-block bg-blue-600 text-lg font-medium rounded-full text-white px-8 py-3 cursor-pointer">Продолжить чтение</span>
			</Link>
		</div>
	</div>
);
